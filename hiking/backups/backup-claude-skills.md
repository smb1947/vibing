...
- **AllTrails filtered URL**: User applies their own filters on alltrails.com (difficulty, distance, elevation, attractions, route type, suitability), then pastes the resulting URL. All filter state is encoded in query params.
